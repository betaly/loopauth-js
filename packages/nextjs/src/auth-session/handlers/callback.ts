...
import {AuthorizationParameters, Config, GetConfig} from '../config';
...
export type HandleCallback = (req: AuthRequest, res: AuthResponse, options?: CallbackOptions) => Promise<void>;
