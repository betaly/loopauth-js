...
export abstract class AbstractClient {
  ...
  abstract callbackParams(req: AuthRequest, expectedState: string): Promise<URLSearchParams>;
  abstract callback(
    redirectUri: string,
  ...
  abstract refresh(refreshToken: string, extras: {exchangeBody?: Record<string, any>}): Promise<TokenEndpointResponse>;
  abstract generateRandomCodeVerifier(): Promise<string>;
  abstract generateRandomNonce(): Promise<string>;
