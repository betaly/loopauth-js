...
import {ConfigParameters} from '../../../auth-session';
import {signing} from '../../../auth-session/utils/hkdf';
import {generateCookieValue} from '../../../auth-session/utils/signed-cookies';
...
export const decodeJWT = (
  ...
  const headerString = String.fromCharCode(...base64url.decode(header));
  const payloadString = String.fromCharCode(...base64url.decode(payload));
  return {
