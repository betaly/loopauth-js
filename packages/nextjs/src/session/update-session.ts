...
import {get, Session, SessionCache, set} from '../session';
 ...
 * ```js
 * // app/my-api/route.js
 * import { getSession, updateSession } from '@loopauth/nextjs';
 *
 ...
 * import { getSession, updateSession, withApiAuthRequired } from '@loopauth/nextjs';
 *
 ...
 * ```js
 * // app/my-page/page.js
 * import { getSession, updateSession } from '@loopauth/nextjs/edge'; // Note the /edge import
 *
 * export default async function Page() {
 *   async function updateUser(updates) {
 *     'use server';
