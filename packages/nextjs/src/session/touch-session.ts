...
import {get, SessionCache, set} from '../session';
 ...
 * ```js
 * // app/my-api/route.js
 * import { touchSession } from '@loopauth/nextjs';
 *
 ...
 * import { touchSession, withApiAuthRequired } from '@loopauth/nextjs';
 *
 ...
 * ```js
 * // app/my-api/route.js
 * import { getSession } from '@loopauth/nextjs/edge'; // Note the /edge import
 *
 * export default async function MyPage({ params, searchParams }) {
 *   await touchSession();
 *   return <h1>My Page</h1>;
 ...
 * import { touchSession } from '@loopauth/nextjs/edge'; // Note the /edge import
 *
